...
判断 advance=true 的条件：用户已经提到了核心系统名称（SaaS或自研系统）且你对数据流向有了大致了解（哪怕有些细节待填补）。如果用户说”可以继续”、”对”、”就是这样”等表示足够了的话，也应 advance=true。不必追求完美信息才前进。`,
  },
  mid_confirm: {
    id: "mid_confirm",
    label: "中段确认",
...
判断 advance=true 的条件：上面 4 点中至少 3 点已拿到具体的、可量化或半量化的答案，即可推进，不必强求 4 点全齐。另外——只要用户明确表达"生成报告""出报告吧""可以了""就这样吧"等结束深挖的意愿，无论信息是否完整，都必须 advance=true，用已有事实生成报告；缺失项可在报告里标注为待补充，绝不要在用户已经要求出报告后还继续追问。`,
  },
  report: {
    id: "report",
    label: "报告生成",
